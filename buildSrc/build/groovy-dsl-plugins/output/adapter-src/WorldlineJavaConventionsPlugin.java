...
/**
 * Precompiled worldline.java-conventions script plugin.
 **/
public class WorldlineJavaConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_WorldlineJavaConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("org.barfuin.gradle.jacocolog");
            target.getPluginManager().apply("maven-publish");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_WorldlineJavaConventions").asSubclass(BasicScript.class);
