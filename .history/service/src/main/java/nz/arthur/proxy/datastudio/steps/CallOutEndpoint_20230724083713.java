package nz.arthur.proxy.datastudio.steps;
...
import nz.arthur.proxy.datastudio.steps.poststeps.PostCallSplunk;
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        return chain.filter(exchange)
                .then(Mono.fromRunnable(() -> {
                    ...
                    headers.set(HttpHeaders.CONTENT_TYPE, "application/vnd.arthur_api+json");
