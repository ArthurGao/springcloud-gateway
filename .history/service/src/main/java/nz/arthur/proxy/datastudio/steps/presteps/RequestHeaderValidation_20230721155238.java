...
public class RequestHeaderValidation extends FilterBase {
    ...
    private static final String VALID_CONTENT_TYPE = "application/vnd.paymark_api+json";
    private static final String VALID_ACCEPT = "application/vnd.paymark_api+json";
